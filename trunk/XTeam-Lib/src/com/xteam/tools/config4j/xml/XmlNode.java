...
public class XmlNode {
	...
	public XmlNode(){
		this.childrenList	= new ArrayList<XmlNode>();
	...
	public void delNode(Element elem){
		...
		Iterator<XmlNode> it	= this.getChildrenByName(name).iterator();
		while(it.hasNext()){
			XmlNode cn	= it.next();
	...
	public void delNode(String ename){
		removeElement(ename);
		Iterator<XmlNode> it	= this.getChildrenByName(ename).iterator();
		while(it.hasNext()){
			XmlNode cn	= it.next();
	...
	public void removeElement(String name){
		List<XmlNode> cns	= this.getChildrenByName(name);
		if(cns!=null){
			for(XmlNode cn:cns){
	 ...
	 * @param cn
	 */
	public void setParent(XmlNode cn){
		this.parent	= cn;
	}
	...
	public Object getValueByPath(String path){
		Object rtn	= null;
		rtn			= XmlNodeUtils.getValueByPath(this,path);
		return rtn;
	}
	...
	public List<XmlNode> getChildrenByName(String name){
		List<XmlNode> clst	= new ArrayList<XmlNode>();
	 ...
	 * @return
	 */
	public XmlNode getOneChildByName(String name){
		XmlNode cn	= null;
		List<XmlNode> cns	= this.getChildrenByName(name);
	 ...
	 */
	public void setChildrenList(List<XmlNode> childrenList) {
	...
	public Element addElement(String name) {
		return this.getElement().addElement(name);
	}
